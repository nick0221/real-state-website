...
export const properties: Property[] = [
  ...
  },
  {
    ...
    status: "available",
    description:
      "Charming coastal bungalow with ocean breezes, a private courtyard garden, and updated interiors blending modern comfort with beachside living.",
    featured: false,
  },
  {
    id: 8,
    ...
    status: "available",
    description:
      "Modern downtown condo with skyline views, premium finishes, and access to rooftop pool, gym, and concierge services.",
    featured: false,
  },
  {
    id: 9,
    ...
    status: "available",
    description:
      "Stunning Napa Valley estate surrounded by vineyards, with a private tasting room, infinity pool, and sweeping valley views.",
    featured: true,
  },
  {
    id: 10,
    ...
    status: "available",
    description:
      "Bright and airy studio loft in the Historic Core, featuring exposed brick, polished concrete floors, and city views.",
    featured: false,
  },
  {
    id: 11,
    ...
    status: "available",
    description:
      "Mid-century modern retreat with mountain views, saltwater pool, fire pit, and indoor-outdoor living at its finest.",
    featured: false,
  },
  {
    id: 12,
    ...
    status: "available",
    description:
      "A meticulously designed family estate with a chef's kitchen, home theater, sports court, and award-winning schools nearby.",
    featured: false,
  },
];
